...
![A diagram that represents an acyclic graph.](../../static/upload/acyclic_graph.png#fluid)
...
![A diagram that represents a cyclic graph.](../../static/upload/cyclic_graph.png#fluid)
